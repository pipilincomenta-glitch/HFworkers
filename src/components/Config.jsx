          ...
          {loading ? (
            ...
            <div style={{ animation: 'fadeIn 0.3s ease' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '30px', marginBottom: '40px' }}>
                 ...
                 <div>
                   <div style={{ fontWeight: '700', fontSize: '18px' }}>{profile.full_name || 'Nuevo Usuario'}</div>
